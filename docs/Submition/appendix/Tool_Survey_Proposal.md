...
**Mutation Testing** giải quyết vấn đề này bằng cách tự động tạo ra các phiên bản lỗi nhỏ của source code (gọi là _mutants_) và kiểm tra xem bộ test có phát hiện ra không. Nếu test vẫn PASS khi code đã bị sai → test đó không đủ tin cậy.
...
- Offutt & Untch (2001). _Mutation 2000: Uniting the Orthogonal._ In Mutation Testing for the New Century.
- Papadakis et al. (2019). _Mutation Testing Advances: An Analysis and Survey._ Advances in Computers.
- Topic T10 description: _Mutation Testing and Test Effectiveness_ — CS423, FIT@HCMUS (2025)

---

_Đề xuất này được nộp cho giai đoạn S1 — Seminar CS423/CSC15003, FIT@HCMUS._  
_Nhóm cam kết thực hiện đúng tiến độ và tuân thủ hướng dẫn AI Disclosure của môn học._
